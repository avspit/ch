...
public class LineChart extends JFrame {
    private static final String TITLE = "Многочлен Ньютона";
    private static final String X_LABEL = "x";
    private static final String Y_LABEL = "y";
    private static final String FUNCTION_LABEL = "График функции";
    private static final String NEWTON_LABEL = "Интерполяция";
    ...
    private XYSeries createLagrangianDataset() {
        XYSeries series = new XYSeries(NEWTON_LABEL);
        xData.forEach(elem -> {
            Newton newton = new Newton(interpolationNodes);
            series.add(elem.getX(), newton.calculate(elem.getX()));
        });
        return series;
    }
