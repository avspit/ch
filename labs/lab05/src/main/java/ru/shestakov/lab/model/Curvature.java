...
public class Curvature {
    ...
    public Curvature(double leftA, double leftB, double leftC, double leftD, double leftX, double leftXn, double rightA, double rightB, double rightC, double rightD, double rightX, double rightXn) {
        this.leftA = leftA;
        this.leftB = leftB;
        this.leftC = leftC;
        this.leftD = leftD;
